...
describe('Blog app', function () {
  ...
  describe('When logged in', function () {
    ...
    it('A blog can be created', function () {
      ...
      cy.contains('New blog added: Cypress test blog');
      cy.get('#logout').click();
    });

    it('A blog can be liked', function () {
      //This works, but any change on the UI could break it. Can't find a way to click the view blog button :(
      //div.container:nth-child(3) should be the blog created before. the second is the blogform and the first one is the nav div
      cy.get('div.container:nth-child(3) > div:nth-child(1) > a:nth-child(1)').click();
    ...
    it('A blog can be commented', function () {
      ...
      //div.container:nth-child(3) should be the blog created before. the second is the blogform and the first one is the nav div
      cy.get('div.container:nth-child(3) > div:nth-child(1) > a:nth-child(1)').click();
      cy.get("[name='comment']").type('Comment made with Cypress');
